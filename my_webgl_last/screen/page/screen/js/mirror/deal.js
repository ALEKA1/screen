...
var Deal={
    ...
    initChart: function(){
        ...
        function winHtml(){
            $('.box-tend,#tend-day').height($(window).height() *.19);
            $('#act-top5,#tend-week,.box,.box-act').height($(window).height() *.23);
            $('#deal-roll,#info-roll').height($(window).height() *.18);
        }
        winHtml();
                    ...
                    lineStyle:{
                        normal:{
                            ...
                            color: new echarts.graphic.LinearGradient(1, 1, 1, 0.3, [{
                                offset: 0, color: '#0F3B5B' // 0% 处的颜色
                            }, {
                                offset: 1, color: '#0AC2F2' // 100% 处的颜色
                            }], false)
                        }
                    },
                    areaStyle:{
