...
class TopN{
  ...
  load(){
      ...
      this.data.forEach((item)=>{
          ...
          let ip = item.sitename;
          html += ` <div class="rank-item">
                            <div style="width: 100%;height: 70%;font-size: 0.14rem;position: relative;top: 0.03rem;">
                                <div class="` + (i <= 5 ? "ani" : "") + `" style="display: inline-block;` + animal + `"><span style="color: rgb(214,224,226);">NO.`+i+`</span></div>
                                <div class="` + (i <= 5 ? "ani" : "") + ` goto" style="display: inline-block;` + animal + `"><span style="color: rgb(214,224,226);"><a target="_blank" href='/screen/monitor.html?domain=`+ip+`'>${item.sitename}</a></span></div>
                                <span class="items-num ` + (i <= 5 ? "ani" : "") + `" style="right: 1%;` + animal + `"><i class="count areaCount timer c-yellow">${item.num}</i></span>
                            </div>
                            <div class="` + (i <= 5 ? "light" : "nolight") + `" style="` + animal + `"></div>
      ...
      this.datas.forEach((items)=>{
          ...
          html += ` <div class="rank-item">
                            <div class="top" style="width: 100%;height: 70%;font-size: 0.14rem;position: relative;top: 0.03rem;">
                                <div class="` + (i <= 5 ? "ani" : "") + `" style="width: 30px; height: 17px; display: inline-block;` + animal + `"><span style="color: rgb(214,224,226);">NO.`+i+`</span></div>
                                <span class="area-icon ` + (i <= 5 ? "ani" : "") + `" style="` + animal + `"><img src="images/flag/`+flag+`.png" /></span>
                                <div class="` + (i <= 5 ? "ani" : "") + `" style="display: inline-block;` + animal + `margin-left: 12%;"><span style="color: rgb(214,224,226);">${items.area}</span></div>
                                <div class="` + (i <= 5 ? "ani" : "") + ` goto" style="display: inline-block;` + animal + `"><span style=" color: rgb(214,224,226);"><a target="_blank" href='/screen/trace-v2.html?ip=`+ip+`&type=`+this.dateType+`'>${items.attackip}</a></span></div>
                                <span class="items-num ` + (i <= 5 ? "ani" : "") + `" style="right: 0.1%;` + animal + `"><i class="count flow_in_count c-yellow" data-decimals="2" >${items.number}</i></span>
                            </div>
                            <div class="` + (i <= 5 ? "light" : "nolight") + `" style="` + animal + `"></div>
                            <div class="items-progress">
                                <span class="items-bar" style="width:`+width+`"></span>
...
class Alarm_trend {
  ...
  load(obj) {
    ...
    $(".trend-menu-item-outer:first-child>.trend-menu-item").addClass("current-item");
      $(".trend-menu-item-outer:nth-child(5n)>.trend-menu-item").addClass("pageChange-item");
      $("#alarm-trend-menu")[0].scrollTop =0;
      let alarmHeight = $("#alarm-trend").height()*0.5;
    ...
    if(obj.series.length > 2) {
      ...
      window.timer = setInterval(()=>{
        if(isMove){
            if($(".current-item").hasClass("pageChange-item")){
                alarmScrollTop += alarmHeight;
                $("#alarm-trend-menu")[0].scrollTop = alarmScrollTop;
            }
            else if($(".current-item").parent(".trend-menu-item-outer").next().length == 0){
                alarmScrollTop = 0;
                $("#alarm-trend-menu")[0].scrollTop = alarmScrollTop;
            }
