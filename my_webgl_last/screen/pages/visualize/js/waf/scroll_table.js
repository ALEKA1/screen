...
(function(global){
	var scrollList={
		...
		init: function(){
			if(this.isFirst){
				$('#grid-title').html('<tr><td>攻击时间</td><td>威胁等级</td><td>攻击源IP</td><td>被攻击站点</td><td>攻击类型</td><td>来源区域</td></tr>');
				this.isFirst=false;
			}
        ...
        var aTag = "<a target='_blank' href='/index.html#/alert_source?saveType=alert&conditions=srcAddress:"+obj['attackSource']+"&conditions=destHostName:"+obj['destAddress']+"&conditions=warningType:"+obj['attakType']+"&start="+start+"&end="+end+"'></a>";
