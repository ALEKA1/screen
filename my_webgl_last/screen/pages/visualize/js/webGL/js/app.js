class Earth {
	constructor(opt) {
		...
		this.flightLineColor = {
		  "0": new THREE.Color(0xF60400),		
		  "1": new THREE.Color(0x993400),		
		  "2": new THREE.Color(0xCCF428),		
		  "3": new THREE.Color(0x058F78),		
...
//  	}
  ...
  addSkyBox() {
  	var cube = new THREE.Mesh(
			new THREE.CubeGeometry(1500, 1000, 1),
  ...
  addGlow() {
  	var moonGlow = new THREE.Mesh(
			new THREE.SphereGeometry(this.radius + 10, this.segments, this.segments),
  	...
  	moonGlow.position.z = -this.radius / 2;
  ...
  addLinght() {
    ...
    var hemiLight1 = new THREE.PointLight(0x33CCFF, 2.2);
  	...
  	//hemiLight.castShadow = true;
    this.scene.add(hemiLight1);
    var hemiLight2 = new THREE.PointLight(0x33CCFF, 0.5);
  	hemiLight2.position.x = 0; 
  ...
  loadFlightLine(data, lineType) {
  	...
  	for(var i = 0; i < data.length; i++) {
  		this.addFlightLine(data[i]["start"], data[i]["end"], lineType, data[i]["type"]);
  	}
  }
  removeAllFlightLine() {
  ...
  addHotspot(cs) {
  	...
  	//for(var i = 0; i < cs.length; i++) {
  		...
  		this.hotspotColor = this.HotspotColor[Math.round(Math.random() * 4)];
